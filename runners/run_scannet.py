...
from vp_estimation_with_prior_gravity.datasets.scannet import ScanNet
...
# Parameters
output_dir = "experiments/scannet/"
...
th_pixels = {
    "calibrated_210": 4.,
    "calibrated_100g": 3.,
    "uncalibrated_220": 2.5,
    "uncalibrated_211": 3.5,
    "uncalibrated_200g": 4.,
    "uncalibrated_110g": 4.,
    "uncalibrated_011g": 6.,
    "hybrid": 4.,
...
def run_scannet(args):
    ...
    dataset = ScanNet(root_dir=args.data_root, split='test')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='VP evaluation on ScanNet.')
    parser.add_argument(

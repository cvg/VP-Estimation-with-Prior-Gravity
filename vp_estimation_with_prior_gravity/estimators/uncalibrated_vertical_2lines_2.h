#ifndef UNCALIBRATED_VERTICAL_VP_ESTIMATORS_UNCALIBRATED_VERTICAL_2LINES_2_H_
#define UNCALIBRATED_VERTICAL_VP_ESTIMATORS_UNCALIBRATED_VERTICAL_2LINES_2_H_

#include "estimators/uncalibrated_vertical_vp_estimator_base.h"

namespace uncalibrated_vp {

class Uncalibrated_Vertical_2lines_2: public Uncalibrated_Vertical_VP_Estimator_Base {
public:
    ...
    Uncalibrated_Vertical_2lines_2 (

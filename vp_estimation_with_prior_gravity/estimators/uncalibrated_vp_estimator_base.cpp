...
double Uncalibrated_VP_Estimator_Base::RANSACScore(const M3D& R, const M3D& K, const double inlier_threshold) const {
    double score = 0;
...
double Uncalibrated_VP_Estimator_Base::MAGSACScore(const M3D& R, const M3D& K, const double inlier_threshold) const {
...
double Uncalibrated_VP_Estimator_Base::Score(const M3D& R, const double focal_length, const double inlier_threshold) const {
...
double Uncalibrated_VP_Estimator_Base::Score(const M3D& R, const M3D& K, const double inlier_threshold) const {
    if (magsac_scoring_)
...
int Uncalibrated_VP_Estimator_Base::NonMinimalSolver(const std::vector<int>& sample, ResultType* res) const {
    return 0;  // NMS is for now disabled for this class
